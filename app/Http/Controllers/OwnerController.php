...
//                dd($request->all());
        ...
        $request->validate([
            ...
            'name'=>'Vardas yra privalomas ir min 3 - max 32 simboliai',
            'surname'=>'Pavardė yra privaloma, max 32 simboliai',
            'surname.min'=>'Pavardė turi būti minimaliai 3 simboliai',
